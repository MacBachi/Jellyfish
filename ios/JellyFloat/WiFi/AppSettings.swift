...
final class AppSettings: ObservableObject {
    ...
    @Published var useCustomNetwork: Bool { didSet { defaults.set(useCustomNetwork, forKey: "useCustomNetwork") } }
    @Published var customSSID: String { didSet { if rememberNetwork { defaults.set(customSSID, forKey: "customSSID") } } }
    /// In memory only unless rememberPassword is on.
    @Published var customPassword: String { didSet { if rememberPassword { Keychain.set(customPassword, account: "customPassword") } } }
    /// Remember the custom SSID (never the password unless rememberPassword). Default on.
    @Published var rememberNetwork: Bool {
        didSet {
    ...
    @Published var joinOnForeground: Bool { didSet { defaults.set(joinOnForeground, forKey: "joinOnForeground") } }
    /// Ask before joining. Default on.
    @Published var askBeforeJoining: Bool { didSet { defaults.set(askBeforeJoining, forKey: "askBeforeJoining") } }
    ...
    @Published var stayConnectedInBackground: Bool { didSet { defaults.set(stayConnectedInBackground, forKey: "stayConnectedInBackground") } }
    ...
    @Published var virtualRingLEDs: Int { didSet { defaults.set(virtualRingLEDs, forKey: "virtualRingLEDs") } }
